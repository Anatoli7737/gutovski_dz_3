...
class TestHomework2(unittest.TestCase):
    ...
    def test_pairs(self):
        self.assertEqual(homework.pairs(''), 0,
                         msg="Expected 0 pairs with empty string")
    ...
    def test_ordered_list(self):
        ...
        self.assertEqual(homework.ordered_list(
            [-1, 2, 0, 1, 0, 2]), [-1, 2, 1, 2, 0, 0])
        self.assertEqual(homework.ordered_list(
            [0, -1, 0, 1, 2]), [-1, 1, 2, 0, 0])
        self.assertEqual(homework.ordered_list(
            [-1, 3, 0, 1, 2]), [-1, 3, 1, 2, 0])
    ...
    def test_tuple_to_list(self):
        self.assertEqual(homework.tuple_to_list(
            ('a', 'b', 'c')), ['a', 'b', 'c'])
    ...
    def test_cities(self):
        self.assertEqual(homework.cities(
    ...
    def test_list_gen(self):
        self.assertEqual(homework.list_gen(['x', 'y'], ['y', 'z', 'v']), [
                         'xy', 'xz', 'xv', 'yy', 'yz', 'yv'])
        self.assertEqual(homework.list_gen(['x', 'y', 'z'], ['y', 'z', 'v']), [
                         'xy', 'xz', 'xv', 'yy', 'yz', 'yv', 'zy', 'zz', 'zv'])
        self.assertEqual(homework.list_gen([], ['y', 'z', 'v']), [])
        self.assertEqual(homework.list_gen(
            [str(i) for i in range(1, 5)], ['x']), ['1x', '2x', '3x', '4x'])

    def test_dict_gen(self):
        self.assertEqual(homework.dict_gen(20), {1: 1, 2: 8, 3: 27, 4: 64, 5: 125, 6: 216, 7: 343, 8: 512, 9: 729,
    ...
    def test_multiplication_table(self):
        gens = [homework.multiplication_table(0), homework.multiplication_table(
            1), homework.multiplication_table(2), homework.multiplication_table(3)]
